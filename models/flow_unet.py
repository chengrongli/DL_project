"""U-Net backbone used by Task1 Flow Matching (checkpoint-compatible with previous setup)."""
...
class UNet(nn.Module):
    """Task1 Flow-Matching U-Net (same architecture/signature as previous ddpm.UNet)."""
    ...
    def __init__(
        ...
        for i, mult in enumerate(channel_mult):
            ...
            for _ in range(num_res_blocks):
                layers = [ConvBlock(channels, out_ch, time_emb_dim, dropout)]
                channels = out_ch
        ...
        for i, mult in list(enumerate(channel_mult))[::-1]:
            ...
            for j in range(num_res_blocks + 1):
                ...
                layers = [ConvBlock(in_channels_up, out_ch, time_emb_dim, dropout)]
                channels = out_ch
